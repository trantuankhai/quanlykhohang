        ...
        <div class="col-md-3">
            <div class="report-box box-blue">
                ...
                <div class="infobox-data">
                    ...
                    <span
                        class="infobox-data-number text-center"><a href="profit"><?php echo (isset($slsorders)) ? cms_encode_currency_format($slsorders) : '0'; ?></a></span>
        ...
        <div class="col-md-3">
            <div class="report-box box-orange">
                ...
                <div class="infobox-data">
                    ...
                    <span class="infobox-data-number"><?php echo (isset($orderFromWeb)) ? cms_encode_currency_format($orderFromWeb) : '0'; ?></span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="widget widget-blue">
            ...
            <div class="widget-body">
                <div class="row">
                    ...
                    <div
                        class="info col-xs-5 data text-right"><b><a  style="color: black;" href="profit"><?php echo (isset($slsorders)) ? cms_encode_currency_format($slsorders) : '0'; ?></a></b></div>
        ...
        <div class="widget widget-orange">
            ...
            <div class="widget-body">
                <div class="row">
                    ...
                    <div
                        class="info col-xs-5 data text-right"><a style="color:black;" href=" inventory"><b><?php echo (isset($slsinventory)) ? cms_encode_currency_format($slsinventory) : '0'; ?></b></a></div>
                    ...
                    <div class="info col-xs-5 data text-right"><b><?php echo (isset($outOfStock)) ? cms_encode_currency_format($outOfStock) : '0'; ?></b></div>
                    <div class="info col-xs-7">Vượt định mức</div>
                    <div class="info col-xs-5 data text-right"><b><?php echo (isset($beyondTheNorm)) ? cms_encode_currency_format($beyondTheNorm) : '0'; ?></b></div>
                </div>
            </div>
        </div>
    </div>
